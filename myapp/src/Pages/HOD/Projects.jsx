...
//       <h1 style={{ textAlign: "center", marginBottom: "1.5rem", fontSize: "clamp(2rem, 4vw, 2.8rem)" }}>FYP Projects</h1>

//       <Tabs activeKey={activeTab} onChange={setActiveTab} style={{ marginBottom: "2rem" }}>
//         <TabPane tab="All Projects" key="all">
//           <Row gutter={[16, 16]} justify="center" className="project-row">
//             {getFilteredProjects().map((project) => (
//               <Col xs={24} sm={12} md={8} lg={6} xl={4} key={project._id}>
//                 <ProjectCard
//                   project={project}
...
//         <TabPane tab={`Pending Evaluation (${pendingHodCount})`} key="pending_hod">
//           <Row gutter={[16, 16]} justify="center" className="project-row">
//             {getFilteredProjects().map((project) => (
//               <Col xs={24} sm={12} md={8} lg={6} xl={4} key={project._id}>
//                 <ProjectCard
...
//         <TabPane tab="Approved" key="hod_approved">
//           <Row gutter={[16, 16]} justify="center" className="project-row">
//             {getFilteredProjects().map((project) => (
//               <Col xs={24} sm={12} md={8} lg={6} xl={4} key={project._id}>
//                 <ProjectCard
...
//         <TabPane tab="Rejected" key="hod_rejected">
//           <Row gutter={[16, 16]} justify="center" className="project-row">
//             {getFilteredProjects().map((project) => (
//               <Col xs={24} sm={12} md={8} lg={6} xl={4} key={project._id}>
//                 <ProjectCard
...
//               <a href={`http://localhost:5000/uploads/${selectedProject.document ? selectedProject.document.replace(/^uploads\//i, "") : ""}`} target="_blank" rel="noopener noreferrer">
//                 View Document
//               </a>
//             </p>
//             <p>
...
const FYPProjects = () => {
  ...
  const handleEvaluateSubmit = async (values) => {
    try {
      ...
      if (values.decision === "hod_approved") {
        message.success("Project approved");
      } else {
        message.info("Project rejected");
      }
